/**
 * Theme Exporter Module
 * Maps color palettes to VS Code theme tokens and generates theme JSON files.
 */

import * as vscode from 'vscode';
import * as path from 'path';
import * as fs from 'fs';
import { Palette, getContrastColor, hexToHsl, hslToHex, ensureContrastRatio } from './colorGenerator';
...
export function mapPaletteToTheme(palette: Palette, themeName?: string, syntaxSaturation: number = 1.0): ThemeDefinition {
    ...
    const bg = type === 'dark' ? adjustBrightness(base, -20) : adjustBrightness(base, 20);
    const editorBg = type === 'dark' ? adjustBrightness(base, -25) : adjustBrightness(base, 25);
    const sidebarBg = type === 'dark' ? adjustBrightness(base, -30) : adjustBrightness(base, 30);
    const activityBarBg = type === 'dark' ? adjustBrightness(base, -35) : adjustBrightness(base, 35);
    ...
    const accentSyntax = ensureContrastRatio(adjustSaturation(accent, syntaxSaturation), editorBg, 3.0);
    const secondarySyntax = ensureContrastRatio(adjustSaturation(secondary, syntaxSaturation), editorBg, 4.5);
    const tertiarySyntax = ensureContrastRatio(adjustSaturation(tertiary, syntaxSaturation), editorBg, 4.5);

    const workbenchColors: Record<string, string> = {
        // Editor
        'editor.background': editorBg,
        'editor.foreground': fg,
        'editor.lineHighlightBackground': adjustBrightness(editorBg, type === 'dark' ? 5 : -5),
        ...
        'editorWhitespace.foreground': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'editorLineNumber.foreground': adjustBrightness(fg, type === 'dark' ? -30 : 30),
        ...
        'titleBar.inactiveBackground': adjustBrightness(activityBarBg, type === 'dark' ? -5 : 5),
        ...
        'statusBar.noFolderForeground': getContrastColor(adjustBrightness(base, -10), 4.5),
        ...
        'button.hoverBackground': adjustBrightness(accent, type === 'dark' ? 10 : -10),

        // Lists
        'list.activeSelectionBackground': accentContrast + '44',
        'list.activeSelectionForeground': fg,
        'list.hoverBackground': adjustBrightness(sidebarBg, type === 'dark' ? 5 : -5),
        ...
        'dropdown.listBackground': adjustBrightness(sidebarBg, type === 'dark' ? 5 : -5),
        ...
        'inputValidation.warningBackground': type === 'dark' ? '#5b5418' : '#f6f5d2',
        ...
        'panelTitle.inactiveForeground': adjustBrightness(fg, type === 'dark' ? -30 : 30),
        ...
        'scrollbarSlider.background': adjustBrightness(editorBg, type === 'dark' ? 20 : -20) + '44',
        'scrollbarSlider.hoverBackground': adjustBrightness(editorBg, type === 'dark' ? 25 : -25) + '66',
        'scrollbarSlider.activeBackground': adjustBrightness(editorBg, type === 'dark' ? 30 : -30) + '88',
        ...
        'peekViewEditor.background': adjustBrightness(editorBg, type === 'dark' ? -5 : 5),
        ...
        'menu.separatorBackground': adjustBrightness(sidebarBg, type === 'dark' ? 10 : -10),

        // Settings Editor
        'settings.headerForeground': fg,
        'settings.modifiedItemIndicator': accentContrast,
        'settings.dropdownBackground': adjustBrightness(editorBg, type === 'dark' ? 8 : -8),
        'settings.dropdownForeground': fg,
        'settings.dropdownBorder': accentContrast + '66',
        'settings.dropdownListBorder': accentContrast + '66',
        'settings.checkboxBackground': adjustBrightness(editorBg, type === 'dark' ? 8 : -8),
        'settings.checkboxForeground': fg,
        'settings.checkboxBorder': accentContrast + '66',
        'settings.textInputBackground': adjustBrightness(editorBg, type === 'dark' ? 5 : -5),
        'settings.textInputForeground': fg,
        'settings.textInputBorder': accentContrast + '66',
        'settings.numberInputBackground': adjustBrightness(editorBg, type === 'dark' ? 5 : -5),
        'settings.numberInputForeground': fg,
        'settings.numberInputBorder': accentContrast + '66',

        // Git Decorations
        'gitDecoration.addedResourceForeground': ensureContrastRatio('#81b88b', sidebarBg, 3.0),
        'gitDecoration.modifiedResourceForeground': ensureContrastRatio('#e2c08d', sidebarBg, 3.0),
        'gitDecoration.deletedResourceForeground': ensureContrastRatio('#c74e39', sidebarBg, 3.0),
        'gitDecoration.untrackedResourceForeground': ensureContrastRatio('#73c991', sidebarBg, 3.0),
        'gitDecoration.ignoredResourceForeground': adjustBrightness(sidebarFg, type === 'dark' ? -30 : 30),
        'gitDecoration.conflictingResourceForeground': ensureContrastRatio('#e4676b', sidebarBg, 3.0),

        // Diff Editor
        'diffEditor.insertedTextBackground': type === 'dark' ? '#9bb95533' : '#9bb95544',
        'diffEditor.removedTextBackground': type === 'dark' ? '#ff000033' : '#ff000044',
        'diffEditor.border': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),

        // Merge Conflicts
        'merge.currentHeaderBackground': type === 'dark' ? '#367366' : '#c2e0c6',
        'merge.currentContentBackground': type === 'dark' ? '#36736633' : '#c2e0c666',
        'merge.incomingHeaderBackground': type === 'dark' ? '#395f8f' : '#b3d7f9',
        'merge.incomingContentBackground': type === 'dark' ? '#395f8f33' : '#b3d7f966',
        ...
        'editorGutter.modifiedBackground': ensureContrastRatio('#e2c08d', editorBg, 3.0),
        'editorGutter.addedBackground': ensureContrastRatio('#81b88b', editorBg, 3.0),
        'editorGutter.deletedBackground': ensureContrastRatio('#c74e39', editorBg, 3.0),
        ...
        'sideBarSectionHeader.background': adjustBrightness(sidebarBg, type === 'dark' ? 8 : -8),
        'sideBarSectionHeader.foreground': sidebarFg,
        'sideBarSectionHeader.border': adjustBrightness(sidebarBg, type === 'dark' ? 15 : -15),

        // List Filter Widget
        'listFilterWidget.background': adjustBrightness(sidebarBg, type === 'dark' ? 15 : -15),
        'listFilterWidget.outline': accentContrast,
        'listFilterWidget.noMatchesOutline': ensureContrastRatio('#c74e39', sidebarBg, 3.0),

        // Tree Indent Guides
        'tree.indentGuidesStroke': adjustBrightness(sidebarBg, type === 'dark' ? 20 : -20),

        // Extension Button
        'extensionButton.prominentBackground': accent,
        'extensionButton.prominentForeground': getContrastColor(accent, 4.5),
        'extensionButton.prominentHoverBackground': adjustBrightness(accent, type === 'dark' ? 10 : -10),

        // Welcome Page
        'welcomePage.background': editorBg,
        'welcomePage.buttonBackground': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'welcomePage.buttonHoverBackground': adjustBrightness(editorBg, type === 'dark' ? 15 : -15),
        'walkThrough.embeddedEditorBackground': adjustBrightness(editorBg, type === 'dark' ? -5 : 5),
        ...
        'editorOverviewRuler.border': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'editorOverviewRuler.currentContentForeground': ensureContrastRatio('#367366', editorBg, 2.0),
        'editorOverviewRuler.incomingContentForeground': ensureContrastRatio('#395f8f', editorBg, 2.0),
        ...
        'editorOverviewRuler.modifiedForeground': ensureContrastRatio('#e2c08d', editorBg, 2.0),
        'editorOverviewRuler.addedForeground': ensureContrastRatio('#81b88b', editorBg, 2.0),
        'editorOverviewRuler.deletedForeground': ensureContrastRatio('#c74e39', editorBg, 2.0),
        'editorOverviewRuler.errorForeground': ensureContrastRatio('#f48771', editorBg, 2.0),
        'editorOverviewRuler.warningForeground': ensureContrastRatio('#cca700', editorBg, 2.0),
        'editorOverviewRuler.infoForeground': ensureContrastRatio('#75beff', editorBg, 2.0),
        'editorOverviewRuler.bracketMatchForeground': accentContrast + '88',

        // Editor Indentation Guides
        'editorIndentGuide.background': adjustBrightness(editorBg, type === 'dark' ? 15 : -15),
        'editorIndentGuide.activeBackground': adjustBrightness(editorBg, type === 'dark' ? 25 : -25),

        // Editor Rulers
        'editorRuler.foreground': adjustBrightness(editorBg, type === 'dark' ? 15 : -15),

        // Editor Code Lens
        'editorCodeLens.foreground': adjustBrightness(fg, type === 'dark' ? -30 : 30),
        ...
        'editor.selectionHighlightBorder': type === 'dark' ? '#ffffff00' : '#00000000',

        // Editor Word Highlight
        'editor.wordHighlightStrongBackground': accentContrast + '33',
        'editor.wordHighlightStrongBorder': type === 'dark' ? '#ffffff00' : '#00000000',
        ...
        'editor.findMatchHighlightBorder': type === 'dark' ? '#ffffff00' : '#00000000',
        'editor.findRangeHighlightBackground': accentContrast + '22',
        'editor.findRangeHighlightBorder': type === 'dark' ? '#ffffff00' : '#00000000',
        ...
        'minimap.errorHighlight': ensureContrastRatio('#f48771', editorBg, 2.0) + '88',
        'minimap.warningHighlight': ensureContrastRatio('#cca700', editorBg, 2.0) + '88',
        'minimapSlider.background': adjustBrightness(editorBg, type === 'dark' ? 20 : -20) + '44',
        'minimapSlider.hoverBackground': adjustBrightness(editorBg, type === 'dark' ? 25 : -25) + '66',
        'minimapSlider.activeBackground': adjustBrightness(editorBg, type === 'dark' ? 30 : -30) + '88',
        'minimapGutter.addedBackground': ensureContrastRatio('#81b88b', editorBg, 2.0),
        'minimapGutter.modifiedBackground': ensureContrastRatio('#e2c08d', editorBg, 2.0),
        'minimapGutter.deletedBackground': ensureContrastRatio('#c74e39', editorBg, 2.0),

        // Editor Markers (Breakpoints, etc)
        'editorMarkerNavigation.background': sidebarBg,
        'editorMarkerNavigationError.background': ensureContrastRatio('#f48771', sidebarBg, 3.0),
        'editorMarkerNavigationWarning.background': ensureContrastRatio('#cca700', sidebarBg, 3.0),
        'editorMarkerNavigationInfo.background': ensureContrastRatio('#75beff', sidebarBg, 3.0),

        // Inlay Hints
        'editorInlayHint.background': adjustBrightness(editorBg, type === 'dark' ? 10 : -10) + 'cc',
        'editorInlayHint.foreground': adjustBrightness(fg, type === 'dark' ? -20 : 20),
        'editorInlayHint.typeBackground': adjustBrightness(editorBg, type === 'dark' ? 10 : -10) + 'cc',
        'editorInlayHint.typeForeground': adjustBrightness(fg, type === 'dark' ? -20 : 20),
        'editorInlayHint.parameterBackground': adjustBrightness(editorBg, type === 'dark' ? 10 : -10) + 'cc',
        'editorInlayHint.parameterForeground': adjustBrightness(fg, type === 'dark' ? -20 : 20),

        // Ghost Text (Suggestions)
        'editorGhostText.foreground': adjustBrightness(fg, type === 'dark' ? -40 : 40),
        'editorGhostText.border': type === 'dark' ? '#ffffff00' : '#00000000',

        // Sticky Scroll
        'editorStickyScroll.background': editorBg,
        'editorStickyScrollHover.background': adjustBrightness(editorBg, type === 'dark' ? 5 : -5),
        ...
        'testing.iconUnset': adjustBrightness(sidebarFg, type === 'dark' ? -20 : 20),
        'testing.iconSkipped': adjustBrightness(sidebarFg, type === 'dark' ? -20 : 20),

        // Problems Panel
        'problemsErrorIcon.foreground': ensureContrastRatio('#f48771', sidebarBg, 3.0),
        'problemsWarningIcon.foreground': ensureContrastRatio('#cca700', sidebarBg, 3.0),
        'problemsInfoIcon.foreground': ensureContrastRatio('#75beff', sidebarBg, 3.0),

        // Status Bar Items
        'statusBarItem.activeBackground': adjustBrightness(accent, type === 'dark' ? -15 : 15),
        'statusBarItem.hoverBackground': adjustBrightness(accent, type === 'dark' ? -10 : 10),
        'statusBarItem.prominentBackground': secondary,
        'statusBarItem.prominentForeground': getContrastColor(secondary, 4.5),
        'statusBarItem.prominentHoverBackground': adjustBrightness(secondary, type === 'dark' ? 10 : -10),
        'statusBarItem.remoteBackground': accent,
        'statusBarItem.remoteForeground': getContrastColor(accent, 4.5),
        'statusBarItem.errorBackground': ensureContrastRatio('#c74e39', editorBg, 3.0),
        'statusBarItem.errorForeground': getContrastColor('#c74e39', 4.5),
        'statusBarItem.warningBackground': ensureContrastRatio('#cca700', editorBg, 3.0),
        ...
        'tab.unfocusedActiveForeground': adjustBrightness(fg, type === 'dark' ? -20 : 20),
        ...
        'tab.lastPinnedBorder': adjustBrightness(sidebarBg, type === 'dark' ? 15 : -15),

        // Editor Group
        'editorGroup.border': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        ...
        'editorGroupHeader.border': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),

        // Side by Side Editor
        'sideBySideEditor.horizontalBorder': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'sideBySideEditor.verticalBorder': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),

        // Interactive Editor (Notebooks)
        'interactive.activeCodeBorder': accentContrast,
        'interactive.inactiveCodeBorder': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),

        // Notebook
        'notebook.cellBorderColor': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'notebook.focusedCellBorder': accentContrast,
        'notebook.cellStatusBarItemHoverBackground': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'notebook.cellInsertionIndicator': accentContrast,
        'notebook.cellToolbarSeparator': adjustBrightness(editorBg, type === 'dark' ? 15 : -15),
        'notebook.selectedCellBackground': adjustBrightness(editorBg, type === 'dark' ? 5 : -5),
        'notebookStatusSuccessIcon.foreground': ensureContrastRatio('#89d185', editorBg, 3.0),
        'notebookStatusErrorIcon.foreground': ensureContrastRatio('#f48771', editorBg, 3.0),
        'notebookStatusRunningIcon.foreground': accentContrast,

        // Keybinding Label
        'keybindingLabel.background': adjustBrightness(editorBg, type === 'dark' ? 10 : -10),
        'keybindingLabel.foreground': fg,
        'keybindingLabel.border': adjustBrightness(editorBg, type === 'dark' ? 20 : -20),
        'keybindingLabel.bottomBorder': adjustBrightness(editorBg, type === 'dark' ? 25 : -25),
    };

    // Colores de sintaxis con contraste garantizado
    const commentColor = type === 'dark' 
...
export async function exportThemeToFile(theme: ThemeDefinition): Promise<string | undefined> {
    const defaultName = theme.name.replace(/[^a-zA-Z0-9-_ ]/g, '').replace(/\s+/g, '-').toLowerCase();
    ...
    vscode.window.showInformationMessage(`Theme exported: ${path.basename(uri.fsPath)}`);
    return uri.fsPath;
}
